...
import 'package:weather_report_app/utils/get_weather_icons.dart';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(weather.name,style: TextStyle(fontSize: 18,color: Colors.white.withOpacity(.8),fontWeight: FontWeight.w400),)
              ],
            ),
          ),
        );
